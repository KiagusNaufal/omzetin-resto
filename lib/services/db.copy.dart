  ...
  try {
    ...
    if (await productDir.exists()) {
      ...
      showErrorDialog(context,
          'Folder produk tidak ditemukan! Pastikan ada data produk sebelum backup.');
    ...
    if (await tokotDir.exists()) {
      ...
      showErrorDialog(context,
          'Folder toko tidak ditemukan! Pastikan ada data toko sebelum backup.');
    ...
    final backupPath = generateUniqueBackupPath(downloadDir, 'backup_OMSETin');
