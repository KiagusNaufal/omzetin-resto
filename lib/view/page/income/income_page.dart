...
import 'package:omsetin_resto/utils/search_utils.dart';
import 'package:omsetin_resto/view/page/Income/Income_detail.dart';
import 'package:omsetin_resto/view/page/income/edit_income.dart';
import 'package:omsetin_resto/view/page/income/input_income_page.dart';
import 'package:omsetin_resto/view/page/product/product.dart';
import 'package:omsetin_resto/view/widget/Income_card.dart';
...
import 'package:omsetin_resto/view/widget/date_from_to/fromTo_v2.dart';
    ...
    return Scaffold(
      ...
      body: Stack(
        children: [
                          ...
                          child: ListView.builder(
                            ...
                            itemBuilder: (context, index) {
                              ...
                              return Column(children: [
                                ...
                                securityProvider.hapusPemasukan
                                    ? Slidable(
                                        key: ValueKey(income.incomeId),
                                                ...
                                                showDialog(
                                                  ...
                                                  builder: (context) {
                                                    return ConfirmDeleteDialog(
                                                      message:
                                                          "Yakin ingin menghapus pemasukan ini?",
                                                      onConfirm: () async {
          ...
          if (securityProvider.tambahPemasukan)
