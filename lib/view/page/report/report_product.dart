...
import 'package:omsetin_resto/view/page/detailReportProduct.dart';
...
import 'package:omsetin_resto/view/widget/modal_status.dart';
                      ...
                      if (snapshot.connectionState == ConnectionState.waiting) {
                        ...
                        if (filteredTransactions.isEmpty) {
                          return Center(
                            ...
                            children: [
                              NotFoundPage(
                                title: 'Tidak ada transaksi Makanan!',
                              ),
                            ],
                          ));
                        }
                            ...
                            Column(
                              children: [
                                ...
                                product_terlarisCard(
                                  context,
                                  sortedProductQuantity.isNotEmpty
