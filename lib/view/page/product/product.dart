...
import 'package:omsetin_resto/utils/navigation_utils.dart';
...
import 'package:omsetin_resto/utils/sort.dart';
import 'package:omsetin_resto/utils/successAlert.dart';
import 'package:omsetin_resto/view/page/product/add_product.dart';
import 'package:omsetin_resto/view/page/product/select_category.dart';
import 'package:omsetin_resto/view/page/product/update_product.dart';
...
import 'package:omsetin_resto/view/widget/createCategoryModal.dart';
...
import 'package:omsetin_resto/view/widget/search.dart';
...
class _ProductPageState extends State<ProductPage>
  ...
  Future<void> _loadPrefs() async {
    ...
    setState(() {
      _isProductOn = prefs.getBool('tambahProduk') ?? true;
      _isDeleteProductOn = prefs.getBool('hapusProduk') ?? true;
      _isEditCategoryOn = prefs.getBool('editKategori') ?? true;
      _isDeleteCategoryOn = prefs.getBool('hapusKategori') ?? true;
    });
  }
  ...
  Future<List<Product>> fetchLatestProducts() async {
    return await fetchProductsSortedByDate("product_date_added", "desc", true);
  }
    ...
    CreateCategoryModal.showCustomModal(
      ...
      onSave: (categoryName) async {
        if (categoryName.isEmpty) {
          showNullDataAlert(context, message: "Nama kategori harus diisi!");
          return;
        }
        ...
        try {
          ...
          showSuccessAlert(
              context, 'Kategori "$categoryName" berhasil diperbarui!');
        } catch (e) {
          showNullDataAlert(context, message: "Gagal memperbarui kategori: $e");
        }
                              ...
                              return CustomRefreshWidget(
                                  ...
                                  child: ListView.builder(
                                    ...
                                    itemBuilder: (context, index) {
                                      ...
                                      return securityProvider.hapusProduk
                                          ? Slidable(
                                ...
                                return CustomRefreshWidget(
                                  ...
                                  child: ListView.builder(
                                    itemBuilder: (context, index) {
                                      ...
                                      return securityProvider.hapusKategori
                                          ? Slidable(
                                              key:
                                                  ValueKey(category.categoryId),
                                              endActionPane: ActionPane(
                                                motion: const DrawerMotion(),
                                                extentRatio: 0.20,
                                                children: [
  ...
  void _handleAddCategory() async {
    final result = await createCategoryModal(
      context: context,
      productCreateCategoryController: _categoryController,
      categoryFocusNode: _categoryFocusNode,
      databaseService: _databaseService,
    );
      ...
      child: Column(
        children: [
          ...
          ElevatedButton(
            ...
            onPressed: _isEditCategoryOn == true
                ? () => _updateCategory(
                      category.categoryId,
