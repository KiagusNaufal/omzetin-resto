...
import 'package:omsetin_resto/view/page/transaction/share_struck_page.dart';
    ...
    showDialog(
      ...
      builder: (context) {
        return FutureBuilder<List<PaymentMethod>>(
          future: DatabaseService.instance.getPaymentMethods(),
          builder: (context, snapshot) {
            ...
            if (snapshot.hasError ||
              ...
              return AlertDialog(
                ...
                content: const Text("Gagal memuat metode pembayaran."),
                actions: [
                  TextButton(
            ...
            String selectedPaymentMethod = metodeList.first.paymentMethodName;
                      ...
                      children: [
                        ...
                        ElevatedButton(
                          onPressed: () async {
                            ...
                            final newStatus = await calculateTransactionStatus(
                                totalBaru, transactionTotal);
              ...
              Padding(
                ...
                child: Row(
                  children: [
                    ...
                    const Gap(6),
                    if (securityProvider.editTransaksi &&
                        _transactionDetail!.transactionStatus !=
                            "Dibatalkan") ...[
                      GestureDetector(
                          onTap: () {
                            List<Product> selectedProducts = [];
              ...
              Container(
                ...
                child: ListView.builder(
                  ...
                  itemBuilder: (context, index) {
                    var product = _transactionDetail!.transactionProduct[index];
                    return Container(
                  ...
                  children: [
                    Row(
                      ...
                      children: [
                        ...
                        GestureDetector(
                          onTap: () {
                            if (securityProvider.kunciBagikanStruk) {
                              showPinModalWithAnimation(context,
                                  pinModal: PinModal(
                                onTap: () {
                                  Navigator.push(
                    ...
                    Padding(
                      ...
                      child: Row(
                        children: [
                          ...
                          if (securityProvider.batalkanTransaksi &&
                              securityProvider.hapusTransaksi)
                            const Gap(10),
