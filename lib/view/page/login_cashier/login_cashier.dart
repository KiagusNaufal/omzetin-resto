...
import 'package:omsetin_resto/model/cashierImageProfile.dart';
...
import 'package:omsetin_resto/view/page/cashier/add_cashier_page.dart';
import 'package:omsetin_resto/view/page/cashier/update_cashier_page.dart';
import 'package:omsetin_resto/view/page/login_cashier/select_cashier.dart';
...
class _LoginCashierState extends State<LoginCashier> {
  ...
  final TextEditingController _cashierImageController = TextEditingController();
              ...
              child: SingleChildScrollView(
                child: Column(
                  ...
                  children: [
                    ...
                    const Gap(35),
                    Image.asset(
                      _cashierImageController.text.isNotEmpty
                          ? _cashierImageController.text
