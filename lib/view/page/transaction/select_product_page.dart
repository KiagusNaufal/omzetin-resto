...
import 'package:omsetin_resto/utils/not_enough_stock_alert.dart';
...
import 'package:omsetin_resto/view/widget/card_select_product.dart';
...
class _SelectProductPageState extends State<SelectProductPage>
  ...
  Future<void> _initializeCategories() async {
    ...
    try {
      _categories = await _databaseService.getDistinctProductCategories();
            ...
            children: [
              ...
              Container(
                ...
                child: FutureBuilder<List<String>>(
                  future: _databaseService.getDistinctProductCategories(),
                          ...
                          : Theme(
                              ...
                              child: TabBar(
                                ...
                                indicator: BoxDecoration(
                                  color:
                                      secondaryColor, // Warna tab yang dipilih
                                  ...
                                  builder: (context, productSnapshot) {
                                    if (productSnapshot.connectionState ==
                                      ...
                                      return const Center(
                                        child: NotFoundPage(
                                          title:
                                              "Tidak ada makanan pada kategori ini!",
                                        ),
                                      );
                                    } else {
