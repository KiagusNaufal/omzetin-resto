...
import 'package:omsetin_resto/view/widget/select_product_stock.dart'; // Import halaman baru
            ...
            children: [
              ...
              Expanded(
                child: filteredProductStock.isEmpty
                    ? const NotFoundPage(title: "Tidak ada produk!")
                    : ListView.builder(
