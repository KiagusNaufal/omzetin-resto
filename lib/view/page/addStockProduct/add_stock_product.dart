...
import 'package:omsetin_resto/view/page/addStockProduct/select_and_add_stock.dart';
...
import 'package:omsetin_resto/view/widget/stock_addition_card.dart';
...
class _AddStockProductPageState extends State<AddStockProductPage> {
  ...
  Future<void> _loadStockAddition() async {
    try {
      final data = await DatabaseService.instance.getStockAddition();
      setState(() {
        _stockAdditionList = Future.value(data);
      });
    } catch (e) {
                      ...
                      child: filteredStock.isEmpty
                          ...
                          : ListView.builder(
                              ...
                              itemBuilder: (context, index) {
                                ...
                                return Padding(
                                  key: ValueKey(stock.stockAdditionId),
        ...
        if (securityProvider.tambahStokProduk == true)
          ExpensiveFloatingButton(
            ...
            onPressed: () async {
              ...
              if (result == true) {
                _loadStockAddition();
                showSuccessAlert(context, "Berhasil Menambahkan Stok Produk!");
              }
            },
            child: Text(
              "TAMBAH",
