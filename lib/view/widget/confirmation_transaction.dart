...
import 'package:omsetin_resto/view/page/detail_history_transaction.dart';
import 'package:omsetin_resto/view/page/transaction/success_transaction_page.dart';
...
void showModalKonfirmasi(
  ...
  showDialog(
    ...
    builder: (context) {
      ...
      DateTime selectedDateTime = lastTransactionDate ?? DateTime.now();
                        ...
                        children: [
                          ...
                          Padding(
                            ...
                            child: _buildCard(
                              ...
                              onTap: (securityProvider.tanggalTransaksi) ==
                                      false
                                  ? null
                                  : () async {
                          ...
                          Padding(
                            ...
                            child: ElevatedButton(
                              onPressed: () async {
                                String currentFormattedDate = DateFormat(
                                        'EEEE, dd/MM/yyyy HH:mm', 'id_ID')
                                    .format(selectedDateTime);
